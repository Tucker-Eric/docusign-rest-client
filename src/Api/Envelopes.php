 ...
 * @method \DocuSign\eSign\Model\EnvelopeSummary createEnvelope(\DocuSign\eSign\Model\EnvelopeDefinition $envelope_definition = null) Creates an envelope
 ...
 * @method \DocuSign\eSign\Model\Recipients createRecipient(string $envelope_id, \DocuSign\eSign\Model\Recipients $recipients = null) Adds one or more recipients to an envelope
 ...
 * @method void getAttachment(string $attachment_id) Retrieves an attachment from the envelope
 ...
 * @method \DocuSign\eSign\Model\ChunkedUploadResponse getChunkedUpload(string $chunked_upload_id = null) Retrieves the current metadata of a ChunkedUpload
 * @method \DocuSign\eSign\Model\ConsumerDisclosure getConsumerDisclosure(string $envelope_id, string $lang_code, string $recipient_id) Reserved
 * @method \DocuSign\eSign\Model\ConsumerDisclosure getConsumerDisclosureDefault(string $envelope_id, string $recipient_id) Gets the Electronic Record and Signature Disclosure associated with the account
 * @method \SplFileObject getDocument(string $document_id, string $envelope_id) Gets a document from an envelope
 * @method \SplFileObject getDocumentPageImage(string $document_id, string $envelope_id, string $page_number) Gets a page image from an envelope for display
 * @method \DocuSign\eSign\Model\Tabs getDocumentTabs(string $document_id, string $envelope_id) Returns tabs on the document
 ...
 * @method \DocuSign\eSign\Model\Envelope getEnvelope(string $envelope_id) Gets the status of a envelope
 ...
 * @method \DocuSign\eSign\Model\PageImages getPages(string $document_id, string $envelope_id) Returns document page image(s) based on input
 ...
 * @method \SplFileObject getRecipientInitialsImage(string $envelope_id, string $recipient_id) Gets the initials image for a user
 ...
 * @method \SplFileObject getRecipientSignatureImage(string $envelope_id, string $recipient_id) Retrieve signature image information for a signer
 ...
 * @method \DocuSign\eSign\Model\Recipients listRecipients(string $envelope_id) Gets the status of recipients for an envelope
 * @method \DocuSign\eSign\Model\EnvelopesInformation listStatus(\DocuSign\eSign\Model\EnvelopeIdsRequest $envelope_ids_request = null) Gets the envelope status for the specified envelopes
 * @method \DocuSign\eSign\Model\EnvelopesInformation listStatusChanges() Gets status changes for one or more envelopes
 * @method \DocuSign\eSign\Model\Tabs listTabs(string $envelope_id, string $recipient_id) Gets the tabs information for a signer or sign
 * @method \DocuSign\eSign\Model\TemplateInformation listTemplates(string $envelope_id) Get List of Templates used in an Envelope
 * @method \DocuSign\eSign\Model\TemplateInformation listTemplatesForDocument(string $document_id, string $envelope_id) Gets the templates associated with a document in an existing envelope
 * @method \DocuSign\eSign\Model\EnvelopeAttachmentsResult putAttachment(string $attachment_id, \DocuSign\eSign\Model\Attachment $attachment = null) Add an attachment to a DRAFT or IN
 ...
 * @method \DocuSign\eSign\Model\EnvelopeUpdateSummary update(string $envelope_id, \DocuSign\eSign\Model\Envelope $envelope = null) Send Draft Envelope
 * @method \DocuSign\eSign\Model\ChunkedUploadResponse updateChunkedUpload(string $chunked_upload_id = null) Integrity
 * @method \DocuSign\eSign\Model\ChunkedUploadResponse updateChunkedUploadPart(string $chunked_upload_id, \DocuSign\eSign\Model\ChunkedUploadRequest $chunked_upload_request = null) Add a chunk
 ...
 * @method void updateDocument(string $document_id, string $envelope_id) Adds a document to an existing draft envelope
 ...
 * @method \DocuSign\eSign\Model\EnvelopeDocumentsResult updateDocuments(string $envelope_id, \DocuSign\eSign\Model\EnvelopeDefinition $envelope_definition = null) Adds one or more documents to an existing envelope document
 ...
 * @method \DocuSign\eSign\Model\RecipientsUpdateSummary updateRecipients(string $envelope_id, \DocuSign\eSign\Model\Recipients $recipients = null) Updates recipients in a draft envelope or corrects recipient information for an in process envelope

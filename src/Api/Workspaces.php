 ...
 * @method Api\WorkspacesApi setApiClient(\DocuSign\eSign\Client\ApiClient $apiClient) Set the API client
 ...
 * @method void deleteWorkspaceFolderItems(string $folder_id, string $workspace_id, Models\WorkspaceItemList $workspace_item_list = null) Deletes workspace one or more specific files
 ...
 * @method void getWorkspaceFile(string $file_id, string $folder_id, string $workspace_id, Api\WorkspacesApi\GetWorkspaceFileOptions $options = null) Get Workspace File

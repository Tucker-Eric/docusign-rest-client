 ...
 * @method \DocuSign\eSign\Model\UserInformationList callList() Retrieves the list of users for the specified account
 ...
 * @method \DocuSign\eSign\Model\UsersResponse delete(\DocuSign\eSign\Model\UserInfoList $user_info_list = null) Removes users account privileges
 ...
 * @method \DocuSign\eSign\Model\UserInformation getInformation(string $user_id) Gets the user information for a specified user
 * @method \DocuSign\eSign\Model\UserProfile getProfile(string $user_id) Retrieves the user profile for a specified user
 * @method \SplFileObject getProfileImage(string $user_id) Retrieves the user profile image for the specified user
 ...
 * @method \SplFileObject getSignatureImage(string $image_type, string $signature_id, string $user_id) Retrieves the user initials image or the  user signature image for the specified user or
 ...
 * @method \DocuSign\eSign\Model\UserSignaturesInformation listSignatures(string $user_id) Retrieves a list of user signature definitions for a specified user
 ...
 * @method \DocuSign\eSign\Model\UserSignature updateSignature(string $signature_id, string $user_id, \DocuSign\eSign\Model\UserSignatureDefinition $user_signature_definition = null) Updates the user signature for a specified user

 ...
 * @method Api\UsersApi setApiClient(\DocuSign\eSign\Client\ApiClient $apiClient) Set the API client
 ...
 * @method void updateProfile(string $user_id, Models\UserProfile $user_profile = null) Updates the user profile information for the specified user
 * @method void updateProfileImage(string $user_id) Updates the user profile image for a specified user
 * @method void updateSettings(string $user_id, Models\UserSettingsInformation $user_settings_information = null) Updates the user account settings for a specified user
 ...
 * @method Models\UserInformation updateUser(string $user_id, Models\UserInformation $user_information = null) Updates the specified user information
 * @method Models\UserInformationList updateUsers(Models\UserInformationList $user_information_list = null) Change one or more user in the specified account
 */

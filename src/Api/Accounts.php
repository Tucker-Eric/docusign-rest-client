 ...
 * @method mixed deleteBrandLogoByType(?string $brand_id, ?string $logo_type) Delete one branding logo or
 ...
 * @method mixed deleteCustomField(?string $custom_field_id, Api\AccountsApi\DeleteCustomFieldOptions $options = null) Delete an existing account custom field
 ...
 * @method mixed getBrandExportFile(?string $brand_id) Export a specific brand
 ...
 * @method mixed getBrandResourcesByContentType(?string $brand_id, ?string $resource_content_type, Api\AccountsApi\GetBrandResourcesByContentTypeOptions $options = null) Returns the specified branding resource file

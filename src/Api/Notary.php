 ...
 * @method Api\NotaryApi setApiClient(\DocuSign\eSign\Client\ApiClient $apiClient) Set the API client
 ...
 * @method void deleteNotaryJurisdiction(string $jurisdiction_id) Delete a notary jurisdiction a specified user
 ...
 * @method void getNotaryJurisdictionSeal(string $jurisdiction_id) Get notary seal for a jurisdiction

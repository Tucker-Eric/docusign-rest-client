 ...
 * @method \DocuSign\eSign\Model\SigningGroupInformation callList() Gets a list of the Signing Groups in an account
 ...
 * @method \DocuSign\eSign\Model\SigningGroupUsers deleteUsers(string $signing_group_id = null) Deletes  one or more members from a signing group
 ...
 * @method \DocuSign\eSign\Model\SigningGroup update(string $signing_group_id = null) Updates a signing group
 ...
 * @method \DocuSign\eSign\Model\SigningGroupUsers updateUsers(string $signing_group_id = null) Adds members to a signing group
 */

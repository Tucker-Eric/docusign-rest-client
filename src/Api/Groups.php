 ...
 * @method Api\GroupsApi setApiClient(\DocuSign\eSign\Client\ApiClient $apiClient) Set the API client
 ...
 * @method Models\BrandsResponse deleteBrands(string $group_id, Models\BrandsRequest $brands_request = null) Deletes brand information from the requested group
 ...
 * @method Models\BrandsResponse getBrands(string $group_id) Gets group brand ID Information
 ...
 * @method Models\BrandsResponse updateBrands(string $group_id, Models\BrandsRequest $brands_request = null) Adds group brand ID information to a group
